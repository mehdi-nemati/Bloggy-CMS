...
namespace Bloggy.Web.Configuration
{
    public class SitemapBuilder
    {
        ...
        private XElement CreateItemElement(SitemapUrlDto url)
        {
            ...
            {
                itemElement.Add(new XElement(NS + "priority", url.Priority.Value.ToString(new CultureInfo("en-us", false))));
            }
